...
describe('Queue', () => {
  describe('#init', () => {
    it('queue should be asserted with proper name and options', () => {
    ...
    it('queue can be asserted without a name', () => {
      const channelStub = ChannelStubs.generate();
      const queueOptions = {
        channel: channelStub,
        options: {
    ...
    it('queue can be asserted without options', () => {
      const channelStub = ChannelStubs.generate();
      const queueOptions = {
        channel: channelStub,
        name: 'test-queue',
    ...
    it('init throws error after assertion fails', () => {
      const channelStub = ChannelStubs.generate();
