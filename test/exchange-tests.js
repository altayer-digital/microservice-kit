...
describe('Exchange', () => {
  describe('#init', () => {
    it('exchange should be asserted with proper name and options', () => {
    ...
    it('exchange can be asserted without a name', () => {
      const channelStub = ChannelStubs.generate();
      const exchangeOptions = {
        channel: channelStub,
        key: 'test',
    ...
    it('should resolve exchange itself', () => {
      const channelStub = ChannelStubs.generate();
      const exchangeOptions = {
        channel: channelStub,
      };
    ...
    it('should set key as name if not provided', () => {
      const channelStub = ChannelStubs.generate();
      const exchangeOptions = {
        channel: channelStub,
        name: 'test',
