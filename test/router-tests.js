...
describe('Router', () => {
  ...
  it('handle method should route events properly', function () {
    ...
    this.router.handle({ eventName: 'event1', payload }, done, progress, routingKey);
    this.router.handle({ eventName: 'event2', payload }, done, progress, routingKey);
  ...
  it('handle method should route multiple events', function () {
    ...
    _.times(10, () => {
      this.router.handle({ eventName: 'event', payload });
    });
